...
<p>
	<label for="<?php echo $this->get_field_id( 'phone' ); ?>"><strong>Phone</strong></label> 
...
<div class="aios-all-widgets-color">
	...
	<div class="aios-all-widgets-color-container">
		...
		<p>
			...
			<input type="text" name="<?php echo $this->get_field_name( 'submenu_text_color_hover' ); ?>" class="color-picker" id="<?php echo $this->get_field_id( 'submenu_text_color_hover' ); ?>" value="<?php echo $parent_text_color_hover; ?>" data-default-color="#FFFFFF" />
		</p>
		<!-- END: 1st Level Sub -->
	</div>
</div>
<div class="aios-all-widgets-color">
	...
	<div class="aios-all-widgets-color-container">
		...
		<p>
			...
			<input type="text" name="<?php echo $this->get_field_name( 'subsubmenu_text_color_hover' ); ?>" class="color-picker" id="<?php echo $this->get_field_id( 'subsubmenu_text_color_hover' ); ?>" value="<?php echo $parent_text_color_hover; ?>" data-default-color="#FFFFFF" />
		</p>
		<!-- END: 2nd Level Sub -->
	</div>
</div>