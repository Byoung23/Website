	...
	protected function getContent() {
		...
		<?php } elseif($section === "free-trial") { ?>
			...
			if(count($errors) === 0) {
				...
				$requestUrl = "https://" . iHomefinderConstants::IHOMEFINDER_STORE_EXTERNAL_URL . "/optima-express-trial.php";
				set_time_limit(90);
				$requestArgs = array(
					"timeout" => "90",
					"body" => $params
				...
				if(!is_wp_error($response)) {
					...
					<p>Your trial account uses sample listing data from Northern California. For search and listings in your MLS, <a href="https://<?php echo iHomefinderConstants::IHOMEFINDER_STORE_EXTERNAL_URL_NEW ?>/trial/conversion/<?php echo $clientId ?>" target="_blank">upgrade to a paid account</a>.</p>
