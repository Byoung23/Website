<?php $cf7_response_style = get_option('cf7_response_style'); ?>
<!-- BEGIN: Row Box -->
	...
	<div class="wpui-col-md-9">
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[text-color]" 
				...
				value="<?=(empty( $cf7_response_style['text-color'] ) ? '#000' : $cf7_response_style['text-color'])?>">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[border-color]" 
				...
				value="<?=(empty( $cf7_response_style['border-color'] ) ? '#ff0000' : $cf7_response_style['border-color'])?>">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[success-border-color]" 
				...
				value="<?=(empty( $cf7_response_style['success-border-color'] ) ? '#398f14' : $cf7_response_style['success-border-color'])?>">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[spam-border-color]" 
				...
				value="<?=(empty( $cf7_response_style['spam-border-color'] ) ? '#ffa500' : $cf7_response_style['spam-border-color'])?>">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[error-border-color]" 
				...
				value="<?=(empty( $cf7_response_style['error-border-color'] ) ? '#f7e700' : $cf7_response_style['error-border-color'])?>">
		</div>
	</div>
</div>
<!-- END: Row Box -->
	...
	<div class="wpui-col-md-9">
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[validation-tip-text-color]" 
				data-default-color="#ff0000" 
				value="<?=(empty( $cf7_response_style['validation-tip-text-color'] ) ? '#ff0000' : $cf7_response_style['validation-tip-text-color'])?>">
		</div>
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[validation-tip-border-color]" 
				data-default-color="#ff0000" 
				value="<?=(empty( $cf7_response_style['validation-tip-border-color'] ) ? '#ff0000' : $cf7_response_style['validation-tip-border-color'])?>">
		</div>
		<div class="form-group">
			...
			<input type="text" class="aios-color-picker" data-alpha="true" name="cf7_response_style[validation-tip-background-color]" 
				...
				value="<?=(empty( $cf7_response_style['validation-tip-background-color'] ) ? '#FFFFFF' : $cf7_response_style['validation-tip-background-color'])?>">
		</div>
	</div>
</div>
<!-- END: Row Box -->
