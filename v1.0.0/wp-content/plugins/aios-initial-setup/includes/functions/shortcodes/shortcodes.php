<div class="aios-shortcode">
	...
	<div class="wpui-row wpui-row-box">
		...
		<div class="wpui-col-md-9">
			<input class="auto-highlight" readonly type="text" value='[ai_phone href="1.800.979.5799"]Call 1.800.979.5799[/ai_phone]'>
			<p class="mb-0"><strong>Attributes:</strong></p>
			<ul>
				<li>
                    <strong>filter - the script automatically adds '.' between the numbers. Set this to 'false' to disable. Default is true</strong>
					<strong>href</strong> - exact phone number details as long as it contains 10 or 11 digits number excluding special characters and spaces<br>
					<em>Sample Values of href:</em>
					<ul>
						<li>+1 (555) 123-4567</li>
						<li>+1 123 456 7890</li>
						<li>+1 098.765.4321</li>
						<li>+1 098-765-TEXT</li>
						<li>123 456 7890</li>
						<li>(555) 123-4567</li>
						<li>098.765.4321</li>
						<li>098-765-4321</li>
