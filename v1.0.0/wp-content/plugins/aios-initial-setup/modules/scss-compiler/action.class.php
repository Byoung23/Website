...
use AIOS\Services\CommonHelper;

class AIOS_Compile_SCSS {
    /**
    ...
    /**
     * Set values for AIOS_Compile_SCSS::properties
     *
    ...
    public function recompile() {
        if ( get_option( 'aios_scss_compiler_development','on' ) ) return true;
