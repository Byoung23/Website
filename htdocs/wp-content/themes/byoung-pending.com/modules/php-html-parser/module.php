 ...
 * Include the Class
 */
require_once( _CLASS_PATH .'/src/PHPHtmlParser/stringEncode/Encode.php');
...
require_once( _CLASS_PATH .'/src/PHPHtmlParser/Dom/LeafNode.php');
require_once( _CLASS_PATH .'/src/PHPHtmlParser/Dom/ArrayNode.php');
require_once( _CLASS_PATH .'/src/PHPHtmlParser/Dom/InnerNode.php');
