	...
	<div class="amh-fixed-header-nav amh-area-wrap">
		<div class="amh-header-buttons amh-3b amh-clearfix">
			...
			<div class="amh-center">
				<?php if ( !$phone_hide ) : ?>
					<a href="tel:<?php echo do_shortcode( $phone ) ?>" class="amh-phone"><span class="ai-phone-o"><span class="amh-phone-text-hide"><?php echo do_shortcode( $phone ) ?></span></span></a>
				<?php endif ?>
			</div>
		...
		<div class="amh-navigation amh-nav-1">
			...
			wp_nav_menu( array( 
				...
				'menu_class'=>'amh-menu',
				'walker'=>new AIOS_Mobile_Header_Menu()
			));
