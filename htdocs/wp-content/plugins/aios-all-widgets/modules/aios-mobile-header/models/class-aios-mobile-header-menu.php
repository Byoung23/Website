...
class AIOS_Mobile_Header_Menu extends Walker_Nav_Menu {
	
	function __construct() {
		
		add_filter('wp_nav_menu_objects',array($this,'check_for_home'),10,2);
	...
	function check_for_home($items,$args) {
		...
		if ( $args->menu_class != 'amh-menu') { return $items; }
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_classes = property_exists($item,'classes') ? (array) $item->classes : array();
