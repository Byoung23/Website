/* Bootstrap-select v1.13.3 | MIT | (https://developer.snapappointments.com/bootstrap-select) */
/** UNSTABLE */
  ...
  (function ($) {
    ...
    Selectpicker.prototype = {
      ...
      init: function () {
        ...
        this.$menuInner = this.$menu.children('.inner-menu');
      ...
      createDropdown: function () {
        ...
        drop =
          '<div class="dropdown bootstrap-select btn-group' + showTick + '">' +
            ...
            '<div class="' + classNames.MENU + ' ' + (version.major === '4' ? '' : classNames.SHOW) + '" role="combobox">' +
              ...
              searchbox +
              actionsbox +
              '<div class="inner-menu ' + classNames.SHOW + '" role="listbox" aria-expanded="false" tabindex="-1">' +
                  '<ul class="' + classNames.MENU + ' inner-menu-menu ' + (version.major === '4' ? classNames.SHOW : '') + '">' +
                  '</ul>' +
              '</div>' +
              donebutton +
            '</div>' +
