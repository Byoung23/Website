<?php
	$aiis_ci_partner_photo = isset( $aiis_ci[ 'partner-photo' ] ) ? $aiis_ci[ 'partner-photo' ] : '';
?>
<!-- BEGIN: Row Box -->
		...
		<div class="form-group">
			<div class="setting-content setting-container setting-container-partner-photo setting-container-parent float-left w-100">
				<div class="setting-partner-photo-preview setting-image-preview">
					<?php 
						if ( !empty( $aiis_ci_partner_photo ) ) {
							echo '<img src="' . $aiis_ci_partner_photo . '">';
						} else {
							echo '<p class="mt-0">No image uploaded</p>';
						}
					?>
				</div>
				<input type="text" class="setting-image-input" name="aiis_ci[partner-photo]" id="aiis_ci[partner-photo]" value="<?=$aiis_ci_partner_photo; ?>" style="display: none;">
